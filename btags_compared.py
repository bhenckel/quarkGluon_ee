...
sklrf_opt.set_params(n_jobs=cpu_n_jobs)
...
probs_lgbm_3jet = btag_df(p_lgbm_3jet, df_3jet)
probs_lgbm_3jet.to_hdf('lgb_btags_3jet.h5', key='df', mode='w')
...
probs_sklrf_3jet = btag_df(p_sklrf_3jet, df_3jet)
probs_sklrf_3jet.to_hdf('sklrf_btags_3jet.h5', key='df', mode='w')
